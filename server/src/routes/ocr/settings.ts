...
const DEFAULT_RECORD_FIELD_CONFIG: Record<string, Array<{
  ...
  baptism: [
    { key: 'child_first_name', label: 'First Name', headerLabel: 'FIRST NAME', required: true, visible: true, sortOrder: 0, type: 'text' },
    { key: 'child_last_name', label: 'Last Name', headerLabel: 'LAST NAME', required: true, visible: true, sortOrder: 1, type: 'text' },
    { key: 'date_of_birth', label: 'Date of Birth', headerLabel: 'DATE OF BIRTH', required: false, visible: true, sortOrder: 2, type: 'date' },
    { key: 'date_of_baptism', label: 'Baptism Date', headerLabel: 'BAPTISM DATE', required: true, visible: true, sortOrder: 3, type: 'date' },
    { key: 'place_of_birth', label: 'Birthplace', headerLabel: 'BIRTHPLACE', required: false, visible: true, sortOrder: 4, type: 'text' },
    { key: 'entry_type', label: 'Entry Type', headerLabel: 'ENTRY TYPE', required: false, visible: true, sortOrder: 5, type: 'text' },
    { key: 'godparents', label: 'Sponsors', headerLabel: 'SPONSORS', required: false, visible: true, sortOrder: 6, type: 'text' },
    { key: 'parents', label: 'Parents', headerLabel: 'PARENTS', required: false, visible: true, sortOrder: 7, type: 'text' },
    { key: 'performed_by', label: 'Officiating Priest', headerLabel: 'OFFICIATING PRIEST', required: false, visible: true, sortOrder: 8, type: 'text' },
    { key: 'notes', label: 'Notes', headerLabel: 'NOTES', required: false, visible: true, sortOrder: 9, type: 'textarea' },
    { key: 'record_number', label: 'Record #', headerLabel: 'NUMBER', required: false, visible: false, sortOrder: 90, type: 'text' },
    { key: 'child_name', label: 'Name of Child (combined)', headerLabel: 'NAME OF CHILD', required: false, visible: false, sortOrder: 91, type: 'text' },
    { key: 'father_name', label: "Father's Name", headerLabel: "FATHER'S NAME", required: false, visible: false, sortOrder: 92, type: 'text' },
    { key: 'mother_name', label: "Mother's Name", headerLabel: "MOTHER'S NAME", required: false, visible: false, sortOrder: 93, type: 'text' },
  ],
  marriage: [
    { key: 'date_of_marriage', label: 'Marriage Date', headerLabel: 'MARRIAGE DATE', required: true, visible: true, sortOrder: 0, type: 'date' },
    { key: 'groom_first_name', label: "Groom's First Name", headerLabel: "GROOM'S FIRST NAME", required: true, visible: true, sortOrder: 1, type: 'text' },
    { key: 'groom_last_name', label: "Groom's Last Name", headerLabel: "GROOM'S LAST NAME", required: true, visible: true, sortOrder: 2, type: 'text' },
    { key: 'groom_parents', label: "Groom's Parents", headerLabel: "GROOM'S PARENTS", required: false, visible: true, sortOrder: 3, type: 'text' },
    { key: 'bride_first_name', label: "Bride's First Name", headerLabel: "BRIDE'S FIRST NAME", required: true, visible: true, sortOrder: 4, type: 'text' },
    { key: 'bride_last_name', label: "Bride's Last Name", headerLabel: "BRIDE'S LAST NAME", required: true, visible: true, sortOrder: 5, type: 'text' },
    { key: 'bride_parents', label: "Bride's Parents", headerLabel: "BRIDE'S PARENTS", required: false, visible: true, sortOrder: 6, type: 'text' },
    { key: 'witnesses', label: 'Witnesses', headerLabel: 'WITNESSES', required: false, visible: true, sortOrder: 7, type: 'text' },
    { key: 'marriage_license', label: 'Marriage License', headerLabel: 'MARRIAGE LICENSE', required: false, visible: true, sortOrder: 8, type: 'text' },
    { key: 'officiant', label: 'Officiating Priest', headerLabel: 'OFFICIATING PRIEST', required: false, visible: true, sortOrder: 9, type: 'text' },
    { key: 'notes', label: 'Notes', headerLabel: 'NOTES', required: false, visible: true, sortOrder: 10, type: 'textarea' },
    { key: 'record_number', label: 'Record #', headerLabel: 'NUMBER', required: false, visible: false, sortOrder: 90, type: 'text' },
    { key: 'groom_name', label: 'Groom Name (combined)', headerLabel: 'GROOM', required: false, visible: false, sortOrder: 91, type: 'text' },
    { key: 'bride_name', label: 'Bride Name (combined)', headerLabel: 'BRIDE', required: false, visible: false, sortOrder: 92, type: 'text' },
  ],
  funeral: [
    { key: 'date_of_death', label: 'Date of Death', headerLabel: 'DATE OF DEATH', required: false, visible: true, sortOrder: 0, type: 'date' },
    { key: 'date_of_burial', label: 'Burial Date', headerLabel: 'BURIAL DATE', required: false, visible: true, sortOrder: 1, type: 'date' },
    { key: 'deceased_first_name', label: "Deceased's First Name", headerLabel: "DECEASED'S FIRST NAME", required: true, visible: true, sortOrder: 2, type: 'text' },
    { key: 'deceased_last_name', label: "Deceased's Last Name", headerLabel: "DECEASED'S LAST NAME", required: true, visible: true, sortOrder: 3, type: 'text' },
    { key: 'age_at_death', label: 'Age at Death', headerLabel: 'AGE AT DEATH', required: false, visible: true, sortOrder: 4, type: 'text' },
    { key: 'officiant', label: 'Officiating Priest', headerLabel: 'OFFICIATING PRIEST', required: false, visible: true, sortOrder: 5, type: 'text' },
    { key: 'place_of_burial', label: 'Burial Location', headerLabel: 'BURIAL LOCATION', required: false, visible: true, sortOrder: 6, type: 'text' },
    { key: 'notes', label: 'Notes', headerLabel: 'NOTES', required: false, visible: true, sortOrder: 7, type: 'textarea' },
    { key: 'record_number', label: 'Record #', headerLabel: 'NUMBER', required: false, visible: false, sortOrder: 90, type: 'text' },
    { key: 'deceased_name', label: 'Deceased Name (combined)', headerLabel: 'NAME OF DECEASED', required: false, visible: false, sortOrder: 91, type: 'text' },
    { key: 'cause_of_death', label: 'Cause of Death', headerLabel: 'CAUSE OF DEATH', required: false, visible: false, sortOrder: 92, type: 'text' },
  ],
};
