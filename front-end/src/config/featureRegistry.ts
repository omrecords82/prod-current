...
export const FEATURE_REGISTRY: FeatureEntry[] = [
  ...
  { id: 'enhanced-ocr-uploader', name: 'OCR Upload', stage: 2, route: '/devel/ocr-studio/upload', since: '2026-01-15', changeSetCode: 'CS-0038' },
  ...
  { id: 'enrollment-onboarding', name: 'Enrollment Onboarding', stage: 2, route: '/admin/onboarding', description: 'Track parish enrollment requests by ONB reference through payment, provisioning, and first-login setup', since: '2026-06-05' },
  { id: 'enrollment-onboarding-detail', name: 'Enrollment Onboarding Detail', stage: 2, route: '/admin/onboarding/:onboarding_request_id', description: 'Onboarding request workspace with status workflow, provisioning, and event timeline', since: '2026-06-05' },
  ...
  { id: 'onboarding-record-layouts', name: 'Onboarding Record Layouts', stage: 2, route: '/onboarding/record-layouts', description: 'First-login layout catalog selection from anonymized parish ledger samples', since: '2026-06-09' },
