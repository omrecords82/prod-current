...
export const DEPRECATION_REGISTRY: DeprecatedEntry[] = [
  ...
  {
    id: 'church-lifecycle-detail-om',
    name: 'OM Church Lifecycle Detail Page',
    stage: 4,
    files: [
    ...
    deprecatedDate: '2026-06-12',
    removedDate: '2026-06-12',
    owner: 'nectarios',
    originalRoute: '/admin/control-panel/church-lifecycle/:churchId',
    redirectTo: '/omai/cp/ops/church-command-center/crm',
    changeSetCode: 'CS-0050',
    category: 'frontend',
  },
  {
    id: 'church-lifecycle-list-om',
    name: 'OM Church Lifecycle List Page',
    stage: 4,
    files: ['features/admin/control-panel/ChurchLifecyclePage.tsx'],
    replacement: 'OMAI Church Command Center CRM tab',
    reason: 'Superseded by OMAI CCC onboarding pipeline and church profile drawer.',
    deprecatedDate: '2026-06-12',
    removedDate: '2026-06-12',
    owner: 'nectarios',
    originalRoute: '/admin/control-panel/church-lifecycle',
    redirectTo: '/omai/cp/ops/church-command-center/crm',
    changeSetCode: 'CS-0050',
    category: 'frontend',
  },
