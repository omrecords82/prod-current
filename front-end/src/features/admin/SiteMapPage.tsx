...
const ADMIN_MAP: SiteNode[] = [
  ...
  },
  {
    label: 'Church Portal', icon: <ChurchIcon />, children: [
      ...
      { label: 'Upload Records', path: '/portal/ocr/upload', icon: <ScanIcon /> },
  ...
  },
  {
    label: 'Public Pages', icon: <PublicIcon />, children: [
      { label: 'Homepage', path: '/', icon: <HomeIcon /> },
      { label: 'About', path: '/about', icon: <PublicIcon /> },
      { label: 'Contact', path: '/contact', icon: <ContactIcon /> },
      { label: 'Portfolio', path: '/', icon: <PublicIcon /> },
      { label: 'Pricing', path: '/pricing', icon: <PublicIcon /> },
      { label: 'Blog', path: '/blog', icon: <BlogIcon /> },
      { label: 'FAQ', path: '/faq', icon: <HelpIcon /> },
      { label: 'Enroll', path: '/enroll', icon: <PublicIcon /> },
      { label: 'OCA Timeline', path: '/', icon: <PublicIcon /> },
      { label: 'Welcome Message', path: '/', icon: <PublicIcon /> },
      { label: 'Tour', path: '/tour', icon: <PublicIcon /> },
      { label: 'Samples', path: '/samples', icon: <PublicIcon /> },
      { label: 'Gallery', path: '/', icon: <ImageIcon /> },
      { label: 'Sacramental Restrictions', path: '/', icon: <CalendarIcon /> },
      { label: 'Tasks Board', path: '/tasks', icon: <TaskIcon /> },
      { label: 'Menu Index', path: '/', icon: <FolderIcon /> },
    ],
  },
  {
...
const USER_MAP: SiteNode[] = [
  {
    label: 'My Portal', icon: <ChurchIcon />, children: [
      ...
      { label: 'OCR Job History', path: '/devel/ocr-studio/jobs', icon: <OcrIcon />, roles: ['super_admin'] },
      { label: 'Sacramental Restrictions', path: '/portal/sacramental-restrictions', icon: <CalendarIcon /> },
    ],
  },
  {
