import type { LegacyPortalLayoutThemeId, PortalLayoutThemeId, PortalThemeMeta } from './types';

/** Pure theme metadata — no layout component imports (safe for CustomizerContext). */
