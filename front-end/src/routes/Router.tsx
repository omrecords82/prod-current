...
const Router = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/frontend-pages/about', element: <Navigate to="/about" replace /> },
      { path: '/frontend-pages/contact', element: <Navigate to="/contact" replace /> },
      { path: '/frontend-pages/pricing', element: <Navigate to="/pricing" replace /> },
      { path: '/frontend-pages/enroll', element: <Navigate to="/enroll" replace /> },
      { path: '/frontend-pages/menu', element: <Navigate to="/" replace /> },
      { path: '/frontend-pages/portfolio', element: <Navigate to="/" replace /> },
      { path: '/frontend-pages/oca-timeline', element: <Navigate to="/" replace /> },
      { path: '/frontend-pages/welcome-message', element: <Navigate to="/" replace /> },
      { path: '/blog/:slug', element: <BlogPost /> },
      { path: '/frontend-pages/blog/detail/:id', element: <BlogPost /> },
      { path: '/frontend-pages/gallery', element: <Navigate to="/" replace /> },
      { path: '/frontend-pages/sacramental-restrictions', element: <Navigate to="/" replace /> },
      { path: '/frontend-pages/tour', element: <Navigate to="/tour" replace /> },
      { path: '/frontend-pages/blog', element: <Navigate to="/blog" replace /> },
      // Public pages with shared header/footer via PublicLayout
      {
        ...
        children: [
          ...
          { path: '/frontend-pages/samples', element: <Navigate to="/samples" replace /> },
