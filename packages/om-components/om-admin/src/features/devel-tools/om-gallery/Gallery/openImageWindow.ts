/**
 * openImageWindow — Opens an image in a new browser window with info and delete action.
 * Extracted from Gallery.tsx (handleOpenInNewWindow).
 */
import type { GalleryImage } from './types';

export function openImageWindow(image: GalleryImage): void {
