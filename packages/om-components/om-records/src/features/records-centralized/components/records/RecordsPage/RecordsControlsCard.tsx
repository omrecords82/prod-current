...
interface RecordsControlsCardProps {
  churches: Church[];
  selectedChurch: number;
  setSelectedChurch: (val: any) => void;
  ...
  setIsFiltersCollapsed: (val: boolean) => void;
  useAgGrid: boolean;
  setUseAgGrid: (val: boolean) => void;
...
const RecordsControlsCard: React.FC<RecordsControlsCardProps> = ({
  churches,
  selectedChurch,
  setSelectedChurch,
  selectedRecordType,
            ...
            {selectedRecordType && (
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} alignItems={{ xs: 'stretch', sm: 'center' }}>
                ...
                >
                  ...
                  <Divider />
                  <MenuItem onClick={() => { onAdvancedGrid(); setMoreMenuAnchor(null); }}>
...
export default RecordsControlsCard;
